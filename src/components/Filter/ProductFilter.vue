<template>
    <aside class="filter">
        ...
        <form class="filter__form form" action="#" method="get" @submit.prevent="submitUpdateFilter">
          ...
          <button class="filter__reset button button--second" type="button" @click.prevent="submitResetFilter">
            Сбросить
          </button>
        </form>
      </aside>
